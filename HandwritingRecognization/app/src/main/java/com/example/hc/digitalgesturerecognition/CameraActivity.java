...
public class CameraActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private TextView tv_flashStatus, tv_flashClose, tv_flashOpen, tv_flashKeepOpen, tv_flashAuto,tvAddNewGesture;
    ...
    private void initView() {
        ...
        tvAddNewGesture=findViewById(R.id.tv_add_new_gesture); //添加新字迹
        ...
        tvAddNewGesture.setOnClickListener(v->addNewGesture()); //添加新字迹
